...
@test isapprox(mdl.Age_025CI, [8199.6, 8033.1, 7990.0, 7970.1, 7887.1, 7853.6, 7830.8, 7794.2, 7768.6, 7751.8, 7737.9], atol=25)
@test isapprox(mdl.Age_975CI, [8401.1, 8380.7, 8341.3, 8167.1, 8155.9, 8127.3, 8019.3, 8011.9, 8002.3, 7985.3, 7956.7], atol=25)
# Test that all age-depth models are in stratigraphic order
@test all([issorted(x, rev=true) for x in eachcol(agedist)])
...
@test isapprox(mdl.Age_025CI, [8210.0, 8011.7, 7983.3, 7969.3, 7916.8, 7885.5, 7867.7, 7837.2, 7740.4, 7728.4, 7717.9], atol=25)
@test isapprox(mdl.Age_975CI, [8405.7, 8268.8, 8234.8, 8164.0, 8153.6, 8131.5, 8073.4, 8038.7, 7952.0, 7929.3, 7913.6], atol=25)
# Test that all age-depth models are in stratigraphic order
@test all([issorted(x, rev=true) for x in eachcol(agedist)])
