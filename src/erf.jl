# I have included this file from SpecialFunctions.jl to avoid problems appearing with symlinks/admin priviledges when installing SpecialFunctions on Windows
